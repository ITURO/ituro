...
from content_management.models import CustomPage, Photo, Gallery, \
...
class CategoryPageAdmin(CustomPageAdmin):
    def get_fieldsets(self, request, obj=None):
        fieldsets = list(super(CustomPageAdmin, self).get_fieldsets(request, obj))
        fieldsets.append((None, {'fields': ["document", "video_url", "gallery"]}))
        return fieldsets
...
class NewsPageAdmin(CustomPageAdmin):
    def get_fieldsets(self, request, obj=None):
        fieldsets = list(super(CustomPageAdmin, self).get_fieldsets(request, obj))
        fieldsets.append((None, {'fields': ["short_description", "url_content", "types", "image"]}))
        return fieldsets
