...
urlpatterns = patterns(
    ...
    # Traffic
    url(r'^traffic/(?P<pid>\d+)/create/$',
        TrafficResultCreateView.as_view(),
        name='traffic_result_create'),
    url(r'^traffic/(?P<pid>\d+)/update/(?P<rid>\d+)/$',
        TrafficResultUpdateView.as_view(),
        name='traffic_result_update'),
    url(r'^traffic/(?P<pid>\d+)/delete/(?P<rid>\d+)/$',
        TrafficResultDeleteView.as_view(),
        name='traffic_result_delete'),

    # Line Football
    url(r'^line_football/(?P<pid>\d+)/create/$',
        LineFootballResultCreateView.as_view(),
        name='line_football_result_create'),
    url(r'^line_football/(?P<pid>\d+)/update/(?P<rid>\d+)/$',
        LineFootballResultUpdateView.as_view(),
        name='line_football_result_update'),
