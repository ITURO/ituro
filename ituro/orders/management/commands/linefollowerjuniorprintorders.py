...
class Command(BaseCommand):
    args = '<day>'
    help = 'Prints race orders of line follower junior category.'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Line Follower Junior Day #{} Orders".format(day))
        for order in LineFollowerJuniorRaceOrder.objects.filter(stage__order=day):
