...
urlpatterns = patterns(
    ...
    url(r'^simulation/$',
        SimulationStageOrderListView.as_view(),
        name='simulation_stage_order_list'),
    url(r'^simulation/stages/(?P<number>\d+)/$',
        SimulationOrderListView.as_view(),
        name='simulation_race_order_list'),
