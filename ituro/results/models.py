...
class ScenarioResult(BaseResult):
    ...
    is_finished = models.BooleanField(verbose_name=_("Is finish?"), default=False)
    is_parked = models.BooleanField(verbose_name=_("Parked?"), default=False)
    sign_successed = models.PositiveSmallIntegerField(default=0,
        verbose_name=_("Successed Signes"))
    sign_failed = models.PositiveSmallIntegerField(default=0,
        verbose_name=_("Failed Signes"))
...
def scenario_result_calculate_score(sender, instance, *args, **kwargs):
    instance.score = sum((
        ...
        instance.is_parked * 200, instance.sign_successed * 20,
