...
class FireFighterResult(BaseResult):
    ...
    wall_hit = models.PositiveSmallIntegerField(
        verbose_name=_("Touching Wall Count"))
    interfering_robots = models.PositiveSmallIntegerField(
        verbose_name=_("Interfering Robots Count"))
    touching_candles = models.PositiveSmallIntegerField(
        verbose_name=_("Touching Candles Count"))
    pre_start_extinguish = models.PositiveSmallIntegerField(
        verbose_name=_("Pre-start Extinguish Count"))
...
def fire_fighter_result_calculate_score(sender, instance, *args, **kwargs):
    instance.score = sum((
        ...
        instance.interfering_robots * (-30),
        instance.pre_start_extinguish * (-50),
...
class StairClimbingResult(BaseResult):
    ...
    is_complete = models.BooleanField(
        verbose_name=_("Finish the race ?"), default=False)
    class Meta:
...
def stair_climbing_result_calculate_score(sender, instance, *args, **kwargs):
    instance.score = sum((
        ...
        (int(instance.down3) + int(instance.down2) + int(instance.down1)) * 10,
...
class ColorSelectingResult(BaseResult):
    ...
    place_partial = models.PositiveSmallIntegerField(
        verbose_name=_("Cylinder Not in Leaving Area Count"))
...
class ScenarioResult(BaseResult):
    ...
    blocks = models.PositiveSmallIntegerField(
        verbose_name=_("Obtained blocks"))
