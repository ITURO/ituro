...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='firefighterresult',
            name='pre_extinguish',
            field=models.PositiveSmallIntegerField(default=0, verbose_name='Pre-Start Systems Count'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='firefighterresult',
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(verbose_name='Penalty Extinguish Count'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='firefighterresult',
            name='wall_hit',
            field=models.PositiveSmallIntegerField(verbose_name='Wall Touching Count'),
            preserve_default=True,
        ),
    ]
